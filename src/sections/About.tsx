...
export default function About() {
  ...
  return (
    <section id="about" className="snap-section relative flex items-center bg-gray-50 dark:bg-gray-950">
      {/* 배경 장식 */}
      ...
      <div className="max-w-7xl mx-auto px-6 py-20 relative z-10 w-full">
        ...
        <div className="text-center mb-16">
          ...
          >
            <h2 className="text-5xl md:text-6xl lg:text-7xl font-thin text-gray-900 dark:text-white mb-6">About Me</h2>
